                    ...
                    >
                        ...
                        <div class="${properties.kcContentWrapperClass!}">
                            <label id="header-${attribute.group.name}"
                                   class="${kcFormGroupHeader!}">${groupHeaderText}</label>
                        </div>
                        ...
                        <#if groupDisplayDescription != "">
                            ...
                            <div class="${properties.kcLabelWrapperClass!}">
                                <label id="description-${group.name}"
                                       class="${properties.kcLabelClass!}">${groupDescriptionText}</label>
                            </div>
                        </#if>
                    </div>
                </#if>
            ...
            <div class="${properties.kcFormGroupClass!}">
                <div class="${properties.kcInputWrapperClass!}">
                    ...
                    <#if messagesPerField.existsError('${attribute.name}')>
                        <span id="input-error-${attribute.name}" class="text-red-500 text-sm ${properties.kcInputErrorMessageClass!}"
                              aria-live="polite">
...
<#macro inputTag attribute value>
    <div class="relative" dir="ltr">
        <input id="${attribute.name}" type="<@inputTagType attribute=attribute/>"
        ...
        <label for="${attribute.name}" class="absolute text-gray-500 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] start-3
